...
String sql = "INSERT INTO fontefinanciamento "+
"(nome) VALUES('" + fontefinanciamento.getNome() + "')";
long x=0;
try {
...
long x = fontefinanciamento.getId();
String sql = "UPDATE fontefinanciamento SET "
+"nome = '"+fontefinanciamento.getNome()+"'"
+" WHERE id = '"+x +"'";
...
try {
ResultSet rs = comando.executeQuery("SELECT * FROM fontefinanciamento "+condicao);
while (rs.next()) {
