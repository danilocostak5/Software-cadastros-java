...
String sql = "INSERT INTO instituicaosubmissao "+
"(nome) VALUES('" + instituicaosubmissao.getNome() + "')";
long x=0;
try {
...
long x = instituicaosubmissao.getId();
String sql = "UPDATE instituicaosubmissao SET "
+"nome = '"+instituicaosubmissao.getNome()+"'"
+" WHERE id = '"+x +"'";
...
ArrayList<InstituicaoSubmissao> lista = new ArrayList<>();
try {
ResultSet rs = comando.executeQuery("SELECT * FROM instituicaosubmissao "+condicao);
while (rs.next()) {
