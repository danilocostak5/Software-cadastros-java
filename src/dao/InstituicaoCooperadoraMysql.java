...
String sql = "INSERT INTO instituicaocooperadora "+
"(nome) VALUES('" + instituicaocooperadora.getNome() + "')";
long x=0;
try {
...
long x = instituicaocooperadora.getId();
String sql = "UPDATE instituicaocooperadora SET "
+"nome = '"+instituicaocooperadora.getNome()+"'"
+" WHERE id = '"+x +"'";
...
try {
ResultSet rs = comando.executeQuery("SELECT * FROM instituicaocooperadora "+condicao);
while (rs.next()) {
