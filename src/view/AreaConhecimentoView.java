...
public class AreaConhecimentoView extends JFrame
{
	...
	public AreaConhecimentoView(AreaConhecimentoTabela t,
			AreaConhecimento areaconhecimento) throws Exception
	{
		super("AreaConhecimento");
	...
	public void inicio(AreaConhecimento areaconhecimento) throws Exception
	{
		...
		id.setEnabled(false);
		nome = new JTextField(areaconhecimento.getNome() == null ? ""
				: areaconhecimento.getNome());
		ciencia = new JTextField((areaconhecimento.getCiencia() == null) ? ""
				: areaconhecimento.getCiencia());
		areaAvaliacao = new JTextField(
				(areaconhecimento.getAreaAvaliacao() == null) ? ""
