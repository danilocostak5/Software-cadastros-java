...
public class AreaFormacaoView extends JFrame{
	...
	public AreaFormacaoView( AreaFormacaoTabela t,AreaFormacao areaformacao) throws Exception{
		super("AreaFormacao");
		inicio(areaformacao);
	...
	public void inicio(AreaFormacao areaformacao) throws Exception{
		...
		id.setEnabled(false);
		nome = new JTextField(areaformacao.getNome()==null?"":areaformacao.getNome());
