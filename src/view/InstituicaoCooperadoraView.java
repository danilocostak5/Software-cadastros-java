...
public class InstituicaoCooperadoraView extends JFrame{
	public InstituicaoCooperadoraView( InstituicaoCooperadoraTabela t) throws Exception{
	...
	public InstituicaoCooperadoraView( InstituicaoCooperadoraTabela t,InstituicaoCooperadora instituicaocooperadora) throws Exception{
		super("InstituicaoCooperadora");
		inicio(instituicaocooperadora);
		salvar.addActionListener(new InstituicaoCooperadoraControl(this,t,instituicaocooperadora));
	}
	JButton salvar;
	public JTextInt id;
	public JTextField nome;
	public void inicio(InstituicaoCooperadora instituicaocooperadora) throws Exception{
		salvar = new JButton("Salvar");
		id = new JTextInt(instituicaocooperadora.getId());
		id.setEditable(false);
		id.setEnabled(false);
		nome = new JTextField(instituicaocooperadora.getNome()==null?"":instituicaocooperadora.getNome());
