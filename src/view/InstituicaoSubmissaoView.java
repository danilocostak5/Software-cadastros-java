...
public class InstituicaoSubmissaoView extends JFrame
{
	...
	public InstituicaoSubmissaoView(InstituicaoSubmissaoTabela t)
			throws Exception
	{
	...
	public InstituicaoSubmissaoView(InstituicaoSubmissaoTabela t,
			InstituicaoSubmissao instituicaosubmissao) throws Exception
	{
		super("InstituicaoSubmissao");
		inicio(instituicaosubmissao);
		salvar.addActionListener(new InstituicaoSubmissaoControl(this, t,
				instituicaosubmissao));
	}
	
	public void inicio(InstituicaoSubmissao instituicaosubmissao)
			throws Exception
	{
		...
		id.setEnabled(false);
		nome = new JTextField(instituicaosubmissao.getNome() == null ? ""
