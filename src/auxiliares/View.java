...
public class View extends JPanel {
	...
	public View() {
		...
		tabela = new JTable();
		JScrollPane scroll = new JScrollPane(tabela,JScrollPane.VERTICAL_SCROLLBAR_AS_NEEDED,JScrollPane.HORIZONTAL_SCROLLBAR_AS_NEEDED);
		tabela.setAutoResizeMode(JTable.AUTO_RESIZE_OFF);
		tabela.setRowHeight(tabela.getFont().getSize()+10);

		DesignGridLayout layout = new DesignGridLayout(this);
		layout.row().grid(new JLabel("Pesquisar: ")).add(pesquisa, 2).add(opcoes).add(tipo).add(pesquisar);
