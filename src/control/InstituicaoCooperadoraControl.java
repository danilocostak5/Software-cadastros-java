...
public InstituicaoCooperadoraControl(InstituicaoCooperadoraView v, InstituicaoCooperadoraTabela t) throws Exception{
this.view=v;
this.tabela=t;
}
public InstituicaoCooperadoraControl(InstituicaoCooperadoraView v, Autocompletee t) throws Exception{
this.view=v;
this.autocp=t;
}
public InstituicaoCooperadoraControl(InstituicaoCooperadoraView v, InstituicaoCooperadoraTabela t,InstituicaoCooperadora o) throws Exception{
this.view=v;
this.tabela=t;
this.obj=o;
}
