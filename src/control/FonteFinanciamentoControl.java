...
public FonteFinanciamentoControl(FonteFinanciamentoView v, FonteFinanciamentoTabela t) throws Exception{
this.view=v;
this.tabela=t;
}
public FonteFinanciamentoControl(FonteFinanciamentoView v, Autocompletee t) throws Exception{
this.view=v;
this.autocp=t;
}
public FonteFinanciamentoControl(FonteFinanciamentoView v, FonteFinanciamentoTabela t,FonteFinanciamento o) throws Exception{
this.view=v;
this.tabela=t;
this.obj=o;
}
