...
PalavraChave obj;
public PalavraChaveControl(PalavraChaveView v, PalavraChaveTabela t) throws Exception{
this.view=v;
this.tabela=t;
}
public PalavraChaveControl(PalavraChaveView v, Autocompletee t) throws Exception{
this.view=v;
this.autocp=t;
}
public PalavraChaveControl(PalavraChaveView v, PalavraChaveTabela t,PalavraChave o) throws Exception{
this.view=v;
this.tabela=t;
this.obj=o;
}
