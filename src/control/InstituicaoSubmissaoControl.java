...
public InstituicaoSubmissaoControl(InstituicaoSubmissaoView v, InstituicaoSubmissaoTabela t) throws Exception{
this.view=v;
this.tabela=t;
}
public InstituicaoSubmissaoControl(InstituicaoSubmissaoView v, Autocompletee t) throws Exception{
this.view=v;
this.autocp=t;
}
public InstituicaoSubmissaoControl(InstituicaoSubmissaoView v, InstituicaoSubmissaoTabela t,InstituicaoSubmissao o) throws Exception{
this.view=v;
this.tabela=t;
this.obj=o;
}
